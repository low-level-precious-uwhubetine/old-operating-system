...
kernel_files = out/obj/kernel/kernel_entry.o \
				...
				out/obj/kernel/drivers/usb_mass_storage.o \
				...
				out/obj/kernel/controls/label.o \
				out/obj/kernel/controls/textbox.o \
				out/obj/kernel/controls/listbox.o \
				out/obj/kernel/controls/msgbox.o \
				out/obj/kernel/controls/gui_event_monitor.o \
				...
				out/obj/kernel/util/image/bmp.o \
				out/obj/kernel/application/explorer.o \
...
out/obj/kernel/%.o: kernel/src/%.cpp
	...
	mkdir -p out/obj/kernel/controls
	mkdir -p out/obj/kernel/util
	mkdir -p out/obj/kernel/util/image
	mkdir -p out/obj/kernel/application
